...
Feature: Verify succesfuly payment
  Scenario: Should payment via banks's pos
   ...
   When Type text with xpath on the "posName","Test-POS10"
   ...
   When Type text with xpath on the "apiUserName","FRY10-TestAPI"
   ...
   When Get "Test-POS10" transaction button using index "posListTable"
   ...
   When Click button with text "Test-POS10"
