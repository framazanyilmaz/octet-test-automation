...
Feature: Verify succesfuly payment
  Scenario: Should payment via banks's pos
   ...
   When Click button with last text "QNB FinansBank"
   ...
   When Type text with xpath on the "apiPassword","FRY921"
   When Type text with xpath on the "threeDKey","123654"
   When Type text with xpath on the "posNo","085300000009597"
   When Type text with xpath on the "mbrld","4"
